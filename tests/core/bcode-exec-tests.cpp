...
TEST_F(BCodeExecTests, Call_Function) {
    ASSERT_TRUE(ready);
...
TEST_F(BCodeExecTests, Call_Method) {
    ASSERT_TRUE(ready);

    our_parcel->mh.add_struct("Math"_str, {});
...
TEST_F(BCodeExecTests, CallNR_Function) {
    ASSERT_TRUE(ready);
...
TEST_F(BCodeExecTests, CallNR_Method) {
    ASSERT_TRUE(ready);
