...
std::string yama::int_const_info::fmt(const const_table&) const {
    return std::format("({}) {}", int_const, fmt_int(v));
}

std::string yama::uint_const_info::fmt(const const_table&) const {
    return std::format("({}) {}", uint_const, fmt_uint(v));
}

std::string yama::float_const_info::fmt(const const_table&) const {
    return std::format("({}) {}", float_const, fmt_float(v));
}

std::string yama::bool_const_info::fmt(const const_table&) const {
    return std::format("({}) {}", bool_const, fmt_bool(v));
}

std::string yama::char_const_info::fmt(const const_table&) const {
...
std::string yama::primitive_type_const_info::fmt(const const_table&) const {
...
std::string yama::function_type_const_info::fmt(const const_table& consts) const {
...
std::string yama::method_type_const_info::fmt(const const_table& consts) const {
    return std::format("({}) {} [{}]", function_type_const, qualified_name, callsig.fmt(consts));
}
...
std::string yama::struct_type_const_info::fmt(const const_table&) const {
    return std::format("({}) {}", struct_type_const, qualified_name);
}

std::string yama::const_table::fmt_info(const info& x, const const_table& consts) {
...
std::optional<yama::kind> yama::const_table::kind(const_t x) const noexcept {
    static_assert(const_types == 9);
...
std::optional<yama::str> yama::const_table::qualified_name(const_t x) const noexcept {
    static_assert(const_types == 9);
    const auto t = const_type(x);
...
const yama::callsig* yama::const_table::callsig(const_t x) const noexcept {
    static_assert(const_types == 9);
    const auto t = const_type(x);
...
std::string yama::const_table::fmt(const char* tab) const {
    YAMA_ASSERT(tab);
    std::string result{};
    result += std::format("const_table ({} consts)", consts.size());
...
yama::const_table& yama::const_table::add_int(int_t v) {
...
yama::const_table& yama::const_table::add_uint(uint_t v) {
...
yama::const_table& yama::const_table::add_float(float_t v) {
...
yama::const_table& yama::const_table::add_bool(bool_t v) {
...
yama::const_table& yama::const_table::add_char(char_t v) {
...
yama::const_table& yama::const_table::add_primitive_type(const str& qualified_name) {
...
yama::const_table& yama::const_table::add_function_type(const str& qualified_name, yama::callsig callsig) {
...
yama::const_table& yama::const_table::add_method_type(const str& qualified_name, yama::callsig callsig) {
...
yama::const_table& yama::const_table::add_struct_type(const str& qualified_name) {
...
yama::const_table& yama::const_table::_patch_function_type(const_t x, yama::callsig new_callsig) {
...
yama::const_table& yama::const_table::_patch_method_type(const_t x, yama::callsig new_callsig) {
    YAMA_ASSERT(x < consts.size());
