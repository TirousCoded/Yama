...
_ADD_1IN1OUT("i" suffix, "Int"_str, expr, as_int, ll_put_int); \
_ADD_1IN1OUT("u" suffix, "UInt"_str, expr, as_uint, ll_put_uint); \
_ADD_1IN1OUT("b" suffix, "Bool"_str, expr, as_bool, ll_put_bool); \
_ADD_1IN1OUT("c" suffix, "Char"_str, expr, as_char, ll_put_char)
...
_ADD_2IN1OUT("i" suffix, "Int"_str, "Int"_str, expr, as_int, ll_put_int); \
_ADD_2IN1OUT("u" suffix, "UInt"_str, "UInt"_str, expr, as_uint, ll_put_uint); \
_ADD_2IN1OUT("f" suffix, "Float"_str, "Float"_str, expr, as_float, ll_put_float); \
_ADD_2IN1OUT("b" suffix, "Bool"_str, "Bool"_str, expr, as_bool, ll_put_bool); \
_ADD_2IN1OUT("c" suffix, "Char"_str, "Char"_str, expr, as_char, ll_put_char)
...
_ADD_2IN1OUT_PANIC_IF_B_IS_0("i" suffix, "Int"_str, "Int"_str, expr, as_int, ll_put_int); \
_ADD_2IN1OUT_PANIC_IF_B_IS_0("u" suffix, "UInt"_str, "UInt"_str, expr, as_uint, ll_put_uint); \
_ADD_2IN1OUT_PANIC_IF_B_IS_0("f" suffix, "Float"_str, "Float"_str, expr, as_float, ll_put_float)
...
_ADD_2IN1OUT_PANIC_IF_B_IS_0("u" suffix, "UInt"_str, "UInt"_str, expr, as_uint, ll_put_uint)
    ...
    // comparison ops
    _ADD_2IN1OUTS_COMMON_R("eq"_str, "Bool"_str, a == b, ll_put_bool);
    _ADD_2IN1OUTS_COMMON_R("ne"_str, "Bool"_str, a != b, ll_put_bool);
    _ADD_2IN1OUTS_COMMON_R("gt"_str, "Bool"_str, a > b, ll_put_bool);
    _ADD_2IN1OUTS_COMMON_R("lt"_str, "Bool"_str, a < b, ll_put_bool);
    _ADD_2IN1OUTS_COMMON_R("ge"_str, "Bool"_str, a >= b, ll_put_bool);
    _ADD_2IN1OUTS_COMMON_R("le"_str, "Bool"_str, a <= b, ll_put_bool);
    ...
    _ADD_1IN1OUT("ineg"_str, "Int"_str, -a, as_int, ll_put_int);
    _ADD_1IN1OUT("fneg"_str, "Float"_str, -a, as_float, ll_put_float);

    // logical ops
    _ADD_2IN1OUT("band"_str, "Bool"_str, "Bool"_str, a && b, as_bool, ll_put_bool);
    _ADD_2IN1OUT("bor"_str, "Bool"_str, "Bool"_str, a || b, as_bool, ll_put_bool);
    _ADD_2IN1OUT("bxor"_str, "Bool"_str, "Bool"_str, a ^ b, as_bool, ll_put_bool);
    _ADD_1IN1OUT("bnot"_str, "Bool"_str, !a, as_bool, ll_put_bool);
    ...
    // we'll just manually write the bit-shift ops
    {
        ...
        auto cf =
            ...
            if (ctx.ll_push_int(a << b).bad()) return;
            if (ctx.ll_ret(0).bad()) return;
            };
        yama::type_info t{
    ...
    _ADD_0IN1OUT_PROMPT_FN("iprompt"_str, "Int"_str, yama::parse_int(input), ll_put_int);
    _ADD_0IN1OUT_PROMPT_FN("uprompt"_str, "UInt"_str, yama::parse_uint(input), ll_put_uint);
    _ADD_0IN1OUT_PROMPT_FN("fprompt"_str, "Float"_str, yama::parse_float(input), ll_put_float);
    _ADD_0IN1OUT_PROMPT_FN("bprompt"_str, "Bool"_str, yama::parse_bool(input), ll_put_bool);
    _ADD_0IN1OUT_PROMPT_FN("cprompt"_str, "Char"_str, yama::parse_char(input), ll_put_char);
...
_ADD_CONV_FN(in_letter, "i", in_type, "Int"_str, yama::int_t, in_as_method, ll_put_int); \
_ADD_CONV_FN(in_letter, "u", in_type, "UInt"_str, yama::uint_t, in_as_method, ll_put_uint); \
_ADD_CONV_FN(in_letter, "f", in_type, "Float"_str, yama::float_t, in_as_method, ll_put_float); \
_ADD_CONV_FN(in_letter, "b", in_type, "Bool"_str, yama::bool_t, in_as_method, ll_put_bool); \
_ADD_CONV_FN(in_letter, "c", in_type, "Char"_str, yama::char_t, in_as_method, ll_put_char)
